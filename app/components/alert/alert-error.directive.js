(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('csc510ProjectApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-csc510ProjectApp-error');
                var entityKey = httpResponse.headers('X-csc510ProjectApp-params');
                if (errorHeader) {
